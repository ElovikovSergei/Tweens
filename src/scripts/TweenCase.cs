...
namespace Tween
{
    ...
    public sealed class TweenCaseDefault : TweenCase
    {
    ...
    public sealed class TweenCaseCondition : TweenCase
    {
    ...
    public sealed class TweenCaseAction<T> : TweenCase
    {
    ...
    public sealed class TweenCaseUpdateNextFrame : TweenCaseNextFrame
    {
    ...
    public sealed class TweenCaseFixedUpdateNextFrame : TweenCaseNextFrame
    {
    ...
    public sealed class TweenCaseLateUpdateNextFrame : TweenCaseNextFrame
    {
    ...
    public sealed class TweenCaseFloat : TweenCase
    {
    ...
    public sealed class TweenCaseColor : TweenCase
    {
    ...
    #region Transform
    public sealed class TweenCaseTransfomRotateAngle : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseTransfomRotateQuaternion : TweenCaseFunction<Transform, Quaternion>
    {
    ...
    public sealed class TweenCaseTransfomLocalRotate : TweenCaseFunction<Transform, Quaternion>
    {
    ...
    public sealed class TweenCaseTransfomLocalRotateAngle : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseTransfomRotateConstant : TweenCase
    {
    ...
    public sealed class TweenCaseTransfomPosition : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseBezierTransfomPosition : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseBezierTransfomFollow : TweenCase
    {
    ...
    public sealed class TweenCaseTransfomFollow : TweenCase
    {
    ...
    public sealed class TweenCaseTransfomPositionX : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomPositionY : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomPositionXZ : TweenCase
    {
        private Transform tweenObject;
    ...
    public sealed class TweenCaseTransfomPositionZ : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomScale : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseTransfomDoPath : TweenCase
    {
    ...
    public sealed class TweenCaseTransfomPushScale : TweenCase
    {
        public Transform tweenObject;
    ...
    public sealed class TweenCaseTransfomScaleX : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomScaleY : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomScaleZ : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomPingPongScale : TweenCase
    {
        private Transform tweenObject;
    ...
    public sealed class TweenCaseTransfomLocalMove : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseTransfomLocalPositionX : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomLocalPositionY : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomLocalPositionZ : TweenCaseFunction<Transform, float>
    {
    ...
    public sealed class TweenCaseTransfomLookAt : TweenCaseFunction<Transform, Vector3>
    {
    ...
    public sealed class TweenCaseTransfomShake : TweenCase
    {
        private Transform tweenObject;
        private Vector3 startPosition;
    ...
    public sealed class TweenCaseRectTransformAnchoredPosition : TweenCaseFunction<RectTransform, Vector2>
    {
    ...
    public sealed class TweenCaseRectTransformAnchoredPosition3D : TweenCaseFunction<RectTransform, Vector3>
    {
    ...
    public sealed class TweenCaseRectTransformAnchoredPositionWithVerticalOffset : TweenCaseFunction<RectTransform, Vector2>
    {
    ...
    public sealed class TweenCaseRectTransformSizeScale : TweenCaseFunction<RectTransform, Vector2>
    {
    ...
    public sealed class TweenCaseRectTransformShake : TweenCase
    {
    ...
    public sealed class TweenCaseLayoutElementPrefferedHeight : TweenCaseFunction<LayoutElement, float>
    {
    ...
    public sealed class TweenCaseSpriteRendererColor : TweenCaseFunction<SpriteRenderer, Color>
    {
    ...
    #region Graphic
    public sealed class TweenCaseGraphicColor : TweenCaseFunction<Graphic, Color>
    {
    ...
    public sealed class TweenCaseGraphicFade : TweenCaseFunction<Graphic, float>
    {
    ...
    #region Image
    public sealed class TweenCaseImageFill : TweenCaseFunction<Image, float>
    {
    ...
    #region Text
    public sealed class TweenCaseTextFontSize : TweenCaseFunction<Text, int>
    {
    ...
    #region TextMesh
    public sealed class TweenCaseTextMeshFontSize : TweenCaseFunction<TextMesh, int>
    {
    ...
    public sealed class TweenCaseTextMeshFade : TweenCaseFunction<TextMesh, float>
    {
    ...
    public sealed class TweenCaseTextMeshColor : TweenCaseFunction<TextMesh, Color>
    {
    ...
    #region TextMesh Pro
    public sealed class TweenCaseTextMeshProFontSize : TweenCaseFunction<TMP_Text, float>
    {
    ...
    #region CanvasGroup
    public sealed class TweenCaseCanvasGroupFade : TweenCaseFunction<CanvasGroup, float>
    {
    ...
    #region AudioSource
    public sealed class TweenCaseAudioSourceVolume : TweenCaseFunction<AudioSource, float>
    {
    ...
    #region Material
    public sealed class TweenCaseMaterialColor : TweenCaseFunction<Material, Color>
    {
        private int colorID;
    ...
    public sealed class TweenCaseMaterialFloat : TweenCaseFunction<Material, float>
    {
        private int floatID;
    ...
    #region Renderer
    public sealed class TweenCasePropertyBlockFloat : TweenCaseFunction<Renderer, float>
    {
    ...
    public sealed class TweenCasePropertyBlockColor : TweenCaseFunction<Renderer, Color>
    {
        private MaterialPropertyBlock materialPropertyBlock;
    ...
    #region Camera
    public sealed class TweenCaseCameraSize : TweenCaseFunction<Camera, float>
    {
    ...
    public sealed class TweenCaseCameraFOV : TweenCaseFunction<Camera, float>
    {
    ...
    #region Animation
    public sealed class AnimationWaitTweenCase : TweenCase
    {
    ...
    public sealed class ParticleSystemWaitTweenCase : TweenCase
    {
    ...
    public sealed class AsyncOperationTweenCase : TweenCase
    {
